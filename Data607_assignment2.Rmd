...
Now, we'll add the rankings into the table
...
Now we have a SQL table with the results of the survey. We can now read it into our R project and manipulate the data using R.
...
Once we have our table saved to the current environment, we should close our connection to the SQL database.
...
Perhaps because of the simple question I asked, all six people answered about all six movies quite quickly. I myself however, have only watched two of them. I watched Top Gun: Maverick, and Avatar: The Way of Water. I would rank them both a 5/5.
